...
export const favicon = () => {
  return src(["./src/favicon/**/*", "./src/favicon/*"]).pipe(
    dest("dist/favicon")
  );
};
...
export const styles = () => {
  return src([
    "./src/components/_core/**.+(sass|scss)",
...
export const server = () => {
  ...
  watch(["src/**/**.pug"], series(templates));

  watch(["src/components/**/**.+(sass|scss)"], series(styles));

  watch(["src/img/**/**.{svg,png,jpg,speg,gif}"], series(cleanImages, images));
